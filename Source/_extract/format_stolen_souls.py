# -*- coding: utf-8 -*-
"""Formatting pass: reflow Stolen Souls Source Texts into readable markdown.

Run AFTER extract_stolen_souls.py (expects raw PDF line breaks).
...
KNOWN_HEADERS = {
    ...
    "END OF THE LINE",
    "LIKELY SUSPECTS",
    "HEAD CRASH AND CORPORATE CLASH",
    "REWIRING MINDS",
    ...
    "STEALING LIVING GOODS",
    "PROTECTING LIVING ASSETS",
    "EXTRACTOR'S TOOLKIT",
    "GETTING THEM OUT",
    "GAME INFORMATION",
    "GAMEMASTERS ONLY!",
