# -*- coding: utf-8 -*-
"""Formatting pass for Dark Terrors Source Texts chapters."""
...
BASE_H2: dict[str, str] = {
    ...
    "darker than shadows": "Darker than Shadows",
    "the heart of the hive": "The Heart of the Hive",
    "marooned spirits": "Marooned Spirits",
    "paint it blacker": "Paint It Blacker",
    "monads and cfd": "Monads and CFD",
    "the hidden faction": "The Hidden Faction",
    "revelations": "Revelations",
    "followers of the elder god": "Followers of the Elder God",
    "dwellers of the deep foundations": "Dwellers of the Deep Foundations",
    "the ghoul queen and her people": "The Ghoul Queen and Her People",
    "untamed metaplanes": "Untamed Metaplanes",
    "rules index": "Rules Index",
    "new bug breeds": "New Bug Breeds",
    "fragments of beyond": "Fragments of Beyond",
    "scarred minds and crumbling towers": "Scarred Minds and Crumbling Towers",
}
...
JP_HANDLE_KEYS = {
    ...
    "rigger x", "miles lanier", "g-nome", "axis mundi", "man-of-many-names",
    "frosty", "elijah", "winterhawk", "ether", "plan 9", "hurricane",
    "red", "stone", "hard exit", "aufheben", "kat o' nine tales",
}
    ...
    for ln in raw_lines:
        ...
        if not skip_headings and is_heading_candidate(s):
            ...
            if key in chapter_keys or key2 in chapter_keys:
                continue
            if key in {"dark terrors", "shadowrun: dark terrors", "shadowrun dark terrors"}:
                continue
