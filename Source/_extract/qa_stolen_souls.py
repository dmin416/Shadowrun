# -*- coding: utf-8 -*-
"""Loss-check / done-check Stolen Souls Source Texts vs PDF."""
...
PDF_PATH = ROOT / "Source" / "PDF" / "stolensouls.pdf"
FOLDER = ROOT / "Source Texts" / "Stolen Souls"
REPORT = ROOT / "Source" / "_extract" / "stolen_souls_qa_report.md"

SECTIONS: list[tuple[str, str, int, int]] = [
    ("01 - Shadowrun Stolen Souls.md", "COVER", 0, 3),
    ("02 - Contents and Credits.md", "CONTENTS", 3, 5),
    ("03 - Freedom Isn't Free.md", "FREEDOM", 5, 9),
    ("04 - JackPoint.md", "JACKPOINT", 9, 10),
    ("05 - Introduction.md", "INTRODUCTION", 10, 11),
    ("06 - Check Your Head.md", "CHECK", 11, 43),
    ("07 - Searching for the Source.md", "SOURCE", 43, 79),
    ("08 - Rewiring Minds.md", "REWIRING", 79, 95),
    ("09 - Persuasion and Power.md", "PERSUASION", 95, 99),
    ("10 - Loaded C-Suites of New York.md", "CSUITES", 99, 117),
    ("11 - Manhattan Vital Stats (2075).md", "MANHATTAN", 117, 125),
    ("12 - Horizon, Evo, and Shiawase.md", "HORIZON", 125, 139),
    ("13 - The Gremlins that Come Between Us.md", "GREMLINS", 139, 143),
    ("14 - Stealing Living Goods.md", "STEALING", 143, 171),
    ("15 - Extractor's Toolkit.md", "TOOLKIT", 171, 193),
    ("16 - Game Information.md", "GAME", 193, 197),
    ("17 - Stolen Souls Tables.md", "TABLES", 197, 202),
]
...
def sample_tokens(text: str, n: int = 10) -> list[str]:
    ...
    skip = {
        ...
        "shadowrun", "page", "contents", "credits", "stolen_souls", "boston",
        "posted", "jackpoint",
    }
    out: list[str] = []
    seen: set[str] = set()
...
def main() -> None:
    ...
    lines = [
        "# Stolen Souls QA report",
        "",
        f"**Overall:** {overall}",
        f"PDF pages: {n_pages}",
        f"Folder: `Source Texts/Stolen Souls/`",
        "",
        "## Chapters",
        "",
        "| File | Status | Detail |",
