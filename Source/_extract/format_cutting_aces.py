# -*- coding: utf-8 -*-
"""Formatting pass: reflow Cutting Aces Source Texts into readable markdown.

Run AFTER extract_cutting_aces.py (expects raw PDF line breaks).
