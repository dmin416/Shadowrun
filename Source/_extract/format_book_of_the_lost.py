# -*- coding: utf-8 -*-
"""Formatting pass: reflow Book of the Lost Source Texts into readable markdown.

Run AFTER extract_book_of_the_lost.py (expects raw PDF line breaks).
...
KNOWN_HEADERS = {
    ...
    "THE MEAN STREETS",
    "TRIAD CONNECTIONS",
    "BLACK MARKET BATTLES AND SMUGGLER'S BLUES",
    "HAPPY HALLOWEENER",
    "VOICES IN THE ELECTRONIC ETHER",
    "DEALER NET",
    "NEON ASCENSION",
    "ORACLE SOCIETY",
    "CORPORATE INTERESTS",
    ...
    "HOW DIFFERENT POWERS PERCEIVE THE TAROT",
    "PUZZLES",
    "USING CARDS AS ADVENTURE HOOKS",
    "SAMPLE OPERATIONS AND CAMPAIGNS",
    "ONE AT A TIME",
    "THE GATES OF WAR",
    ...
    "CARDS AS AUGURY",
    "THE DECK AS TAROT",
    "THE DECK AS PROPHETIC IMAGES",
    "THE DECK'S ROLE IN SHAPING THE FUTURE",
    "POWER OF THE CARDS",
    "SETS OF FOUR",
    "MAJOR ARCANA",
    "MIX AND MATCH",
    "CHARACTER TROVE",
    # People / trove NPC names that appear as ALL CAPS banners
    "KAZE ADEKI",
    "KYLE BLACKLIGHTER",
    "JOYGIRL-IX",
    "EMILY LLANFRECHFA",
