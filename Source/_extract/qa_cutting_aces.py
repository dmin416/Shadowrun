# -*- coding: utf-8 -*-
"""Loss-check / done-check Cutting Aces Source Texts vs PDF."""
...
PDF_PATH = ROOT / "Source" / "PDF" / "Shadowrun_5E_Cutting_Aces.pdf"
FOLDER = ROOT / "Source Texts" / "Cutting Aces"
REPORT = ROOT / "Source" / "_extract" / "cutting_aces_qa_report.md"

SECTIONS: list[tuple[str, str, int, int]] = [
    ("01 - Shadowrun Cutting Aces.md", "COVER", 0, 2),
    ("02 - Contents & Credits.md", "CONTENTS", 2, 3),
    ("03 - Introduction.md", "INTRODUCTION", 3, 4),
    ("04 - Operation Constantinople.md", "OPERATION", 4, 8),
    ("05 - Fast and Loose.md", "FAST", 8, 48),
    ("06 - City of the World's Desire.md", "CITY", 48, 86),
    ("07 - From the Artist's Perspective.md", "ARTIST", 86, 90),
    ("08 - Alibi Agents of Constantinople.md", "ALIBI", 90, 106),
    ("09 - The Art of Confidence.md", "CONFIDENCE", 106, 132),
    ("10 - Gats and Glad Rags.md", "GATS", 132, 156),
    ("11 - The Grifting Bible.md", "GRIFTING", 156, 170),
]
...
def sample_tokens(text: str, n: int = 10) -> list[str]:
    ...
    skip = {
        ...
        "shadowrun", "page", "contents", "credits", "cutting", "aces",
        "posted", "jackpoint",
    }
    out: list[str] = []
    seen: set[str] = set()
...
def main() -> None:
    ...
    lines = [
        "# Cutting Aces QA report",
        "",
        f"**Overall:** {overall}",
        f"PDF pages: {n_pages}",
        f"Folder: `Source Texts/Cutting Aces/`",
        "",
        "## Chapters",
        "",
        "| File | Status | Detail |",
