# -*- coding: utf-8 -*-
"""Formatting pass: reflow Rigger 5.0 Source Texts into readable markdown.

Run AFTER extract_rigger5.py (expects raw PDF line breaks).
