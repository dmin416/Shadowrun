...
- [x] Create `Encyclopedia/` folder
- [x] Create stub file per major item type
- [x] Create `Encyclopedia/INDEX.md`
...
- [ ] Cross-link related Mechanics pages from each item-type file
- [ ] Add supplement source tags per entry (Core / RnG / CF / R5 / etc.)
- [ ] Decide: one mega-table per file vs one heading per item
- [ ] Optional: split oversized categories (e.g. Firearms → Pistols / Automatics / Longarms)
