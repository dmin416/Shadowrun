...
**Books:** Core · R5 · SS
**Printed:** Core Street Gear vehicles/drones ~PDF 466 (print ~461); R5 Drone Modification ~PDF 123-128 (print ~122-127); R5 Building the Perfect Beast ~PDF 151-172 (print ~150-171); SS Extractor's Toolkit vehicle mods ~PDF 188 (print ~186)
**See also:** `Encyclopedia/Vehicles.md` · `Encyclopedia/Drones.md` · `Encyclopedia/Rigger Gear.md` (RCC; jumped-in essentials also listed here) · `Encyclopedia/Medical Gear.md` (Valkyrie) · `Encyclopedia/Sensors and Optics.md` (ECM/Signature Masking cross) · `Encyclopedia/Commlinks and Electronics.md` (handheld sat link) · `Encyclopedia/Armor Modifications.md` (special armor mod bases) · `Encyclopedia/Tools Kits and Survival.md` (kits/shops/facilities)

**Scope:** Core vehicle mod buy lines; R5 vehicle equipment (non-slot); R5 vehicle mods (6 slot categories); R5 drone Mod Points + drone chapter software (pilots/autosoft prices/tweaks); SS extractor vehicle-mod buy table.
**Not here:** vehicle/drone chassis SKUs; RCC hardware models (Rigger Gear); handheld jammer as non-vehicle gear (Commlinks / Sensors); SS uniforms/fixer/forger/rigger *services* (Identity / Tools as appropriate).
...
**R5 Drone mods:** Attribute up/down formulas; Weapon Mounts Micro-Heavy; Pop-out (blow-away / pop-up); Expanded Ammo Bay; Belt-feed; Realistic Features R1-4; Amphibious R1-2; Assembly Time Improvement; Customized; Drone Arm (+Primitive); Drone Leg; Gecko Grips; Immobile; SkyGuide; Spotlight; Suspension Mod; Tire Mod; Pilot R1-6; Autosoft price row; Personality; Linguistics (+ Skillset list pointer)
**SS Extractor vehicle mods (9 buy rows + service):** Chameleon coating (SS price); Dash light bar; Emergency light bar; Morphing license plate; Siren; Smuggling compartment (metahuman); Smuggling compartment (troll); Spoof chips; Rigger services (hourly)
...
| --- | --- |
| Src | Core / R5 |
| Cat | Equipment (no slots) / Power / Protection / Weapons / Body / Electromagnetic / Cosmetic / Drone / SS |
...
| Secondary Propulsion: Amphibious Surface | R5 | Power | 4 | 10 | Shop | - | 6 | Body x 200¥ | Float/travel on water (hull/skirts/pontoons); mods **obvious**. May use normal propulsion or low-power prop (limited speed/handling). River/sound/bay OK; not ocean-crossing. Switch to mode table H/S/A (cannot improve). |
| Secondary Propulsion: Amphibious Submersible | R5 | Power | 8 | 20 | Shop | - | 12R | Body x 2,000¥ | Watertight seals + underwater drive (prop/waterjet) + ballast. More subtle than surface. Depth ~100 m; not extreme conditions. Mode table H/S/A. |
| Secondary Propulsion: Hovercraft | R5 | Power | 8 | 16 | Shop | - | 12 | Body x 1,000¥ | Inflatable skirt; few cm hover; can cross water; sluggish. Mode table H/S/A. |
| Secondary Propulsion: Rotor | R5 | Power | 10 | 24 | Facility | - | 12R | Body x 3,000¥ | Folding top rotors + retractable tail stabilizer. Flies but handles poorly. Mode table H/S/A. |
| Secondary Propulsion: Tracked | R5 | Power | 6 | 14 | Shop | - | 10 | Body x 1,000¥ | Jacks up, retracts tires, deploys tracks. Rough terrain; pivot in place; limited speed. Mode table H/S/A. |
| Secondary Propulsion: Walker | R5 | Power | 8 | 16 | Shop | - | 12 | Body x 2,000¥ | 4-8 retractable legs; body ~1 m clearance. Metahuman-like stop/pivot; limited speed. Mode table H/S/A. |
...
| Special Armor Modification | R5 | Protection | 2 | 12 | Shop | Armorer | (As Mod) | (As Mod) x 2 | Allowed types only (as personal armor Core 437-438): Chemical Protection, Fire Resistance, Insulation, Nonconductivity, Radiation Shielding, Universal Mirror Material. Max Rating = vehicle Armor value. Take multiple times, different type each. Cost/Avail = double / same as the personal armor mod (see Armor Modifications: Chem/Fire/Insul/Noncond = Avail 6, Rating x 250¥ base; Radiation Shielding Avail Rating x 2, Rating x 200¥; Universal Mirror Material Avail 8F, Rating x 250¥/m² then x2). |
...
| Chameleon Coating | R5 | Body | 2 | 10 | Facility | - | 12F | Body x 1,000¥ | Display any image Free Action. Sensor-mimic cloak: if <= Walking rate, Perception to find -3. **Conflict:** SS table lists Avail **12R**, Cost **Body x 2,000¥** (no slot row). Prefer R5 for Perfect Beast installs; note SS if using Extractor's Toolkit pricing. |
...
| Smuggling Compartment | R5 | Body | 3 | 16 | Facility | - | 8F | 1,500¥ | Hidden; Perception -6 if searching thoroughly. Non-visual senses no penalty unless Shielding. ~10-20% vehicle size (GM). **Conflict:** SS sells metahuman-sized people compartments at different Avail/Cost (see SS section). |
...
| Realistic Features R1 | R5 | Drone | (no MP listed) | Shop (R3+ Facility) | 2 | (Body x Body) x 100¥ | Perception threshold = Rating to spot artificial. Most drones max R1; GM veto by form. |
| Realistic Features R2 | R5 | Drone | (no MP listed) | Shop | 4 | (Body x Body) x 500¥ | As R1; threshold 2. Shop install. |
| Realistic Features R3 | R5 | Drone | (no MP listed) | Facility | 8 | (Body x Body) x 1,000¥ | As R1; threshold 3. Facility. |
| Realistic Features R4 | R5 | Drone | (no MP listed) | Facility | 12R | (Body x Body) x 5,000¥ | As R1; threshold 4. Facility. |
...
### Drone pilots, autosofts, tweaks (R5 ~p.126-128; also in Rigger Gear)

| Name | Src | Cat | MP | Avail | Cost | Rules |
| --- | --- | --- | --- | --- | --- | --- |
| Pilot Program R1 | R5 | Drone | - | 4 | 100¥ | Device Rating = Pilot. Caps native autosoft Rating. Civilian often 1-2; security 3-4 (R); military 5-6 (F). |
| Pilot Program R2 | R5 | Drone | - | - | 400¥ | Typical civilian. |
| Pilot Program R3 | R5 | Drone | - | 8R | 1,800¥ | Security band. |
| Pilot Program R4 | R5 | Drone | - | 12R | 3,200¥ | Security band. |
| Pilot Program R5 | R5 | Drone | - | 16F | 10,000¥ | Military band. |
| Pilot Program R6 | R5 | Drone | - | 24F | 20,000¥ | Military band. |
| Autosoft (Rating 1-6) | R5 | Drone | - | Rating x 2 | Rating x 500¥ | Model-specific where tagged. Native run <= Pilot; RCC can share higher. Types: Clearsight; Electronic Warfare; [Model] Evasion / Maneuvering / Stealth; [Weapon] Targeting; Smartsoft (counts as R3, Restricted); Group (counts as R2); Skillset (Academic Knowledge; Chemistry R; Demolitions R; EW R; First Aid; Hardware; Instruction; Language; Lockpicking R; Mechanic; Medicine R; Melee; Navigation; Performance; Professional Knowledge). Full skill/use rules -> Rigger Gear. |
| Personality tweak | R5 | Drone | - | 4 | 100¥ | Pilot develops unique flavor over time (playful, territorial, etc.); can specify at purchase or let develop. No performance change. |
| Linguistics tweak | R5 | Drone | - | 4 | 50¥ | Verbal-command vocabulary pack. Factory: usually 2 languages (mfr + sales region). Pilot may hold Linguistics packs up to its Rating. Limited vocab (come/go/shoot/find); **not** translation. Real translation = Language Skillset autosoft. |

Pilots/autosofts/RCC sharing also cataloged in `Encyclopedia/Rigger Gear.md`.

---

## Stolen Souls extractor vehicle mods (SS ~p.186 / PDF 188)

Buy table for counterfeit emergency/gov vehicles. **No R5-style slot/threshold/tools rows.** Overlaps R5 on chameleon / morphing plate / spoof / smuggling with different prices where noted. Flavor: light bars, chassis false panels, paint/chameleon for LE/ambulance looks; people-smuggling compartments need ventilation/climate (prose).

| Name | Src | Cat | Avail | Cost | Rules |
| --- | --- | --- | --- | --- | --- |
| Chameleon coating | SS | Body/Equipment | 12R | Body x 2,000¥ | Same concept as R5 Chameleon Coating (display/paint/patterns; used for LE/ambulance schemes). **Avail/Cost differ from R5** (12F / Body x 1,000¥ + slots). |
| Dash light bar | SS | Cosmetic/Equipment | 15F | 3,500¥ | Dashboard/interior emergency light bar for counterfeit LE/gov look. No other printed mechanical effects. |
| Emergency light bar | SS | Cosmetic/Equipment | 15F | 5,000¥ | Exterior emergency light bar for ambulance/patrol counterfeit. No other printed mechanical effects. |
| Morphing license plate | SS | Equipment | 8F | 1,000¥ | Same buy line as R5 equipment. |
| Siren | SS | Cosmetic/Equipment | 15F | 1,400¥ | Emergency siren for counterfeit LE/ambulance. No other printed mechanical effects. |
| Smuggling compartment (dwarf/human/elf/ork) | SS | Body | 12F | 3,500¥ | People-sized hidden compartment for listed metatypes. SS prose: restraints, ventilation/climate, optional O2. **Different SKU/price from R5** general smuggling compartment (8F / 1,500¥). |
| Smuggling compartment (troll) | SS | Body | 12F | 7,000¥ | As above, troll-sized. |
| Spoof chips | SS | Equipment | 8F | 500¥ | Same buy line as R5 spoof chip. |
| Rigger services | SS | Service | - | 500¥/hour | Hire rigger labor for counterfeit/emergency conversions (not a permanent mod). |

Chassis list for counterfeits (buy vehicles in Vehicles.md): Ares Roadmaster; Chrysler-Nissan Journey; Conestoga Trailblazer; Dodge Ram Industrial; Esprit Watcher; GMC Endurance; GMC Sidewinder; Honda Artemis; S-K LT-21.
...
- **Micro drone rack:** size described (up to 10 micro); no Mini-style buy row for Micro.
...
- **R5 vs SS chameleon:** R5 12F Body x 1,000¥ (slots); SS 12R Body x 2,000¥ (table only).
- **R5 vs SS smuggling:** R5 general 8F 1,500¥; SS people-sized 12F 3,500¥ / troll 7,000¥.
- **Drone Realistic Features:** no Mod Point cost printed (unlike most drone mods).
- **GYRO:** only flavor in Handling Enhancement / drone Handling text; not a separate SKU.

---

## Item index

Acceleration Enhancement; Amenities; Ammo Bin; Amphibious (drone / vehicle secondary); Anti-Theft System; Armor (vehicle); Assembly/Disassembly; Assembly Time Improvement; Autosoft; Belt-feed; Blow-away panels; Chameleon Coating (R5/SS); Customized; Dash light bar (SS); Drone Arm; Drone Leg; Drone Rack (standard/landing); ECM; Ejection Seats; Electromagnetic Shielding; Emergency light bar (SS); Enhanced Image Screens; Expanded ammo bay; Extra Entry/Exit Points; Extreme Environment Modification; Gecko Grips; Gecko Tips; Gliding System; Gridlink; Gridlink Override; Gun Port; Handling Enhancement; Immobile; Improved Economy; Increased Seating; Interior Cameras; Life Support; Linguistics; Manual Control Override; Manual operation (Core); Mechanical Arm; Metahuman Adjustment; Missile Defense System; Morphing license plate; Multifuel Engine; Nanomaintenance System; Off-Road Suspension; Off-road / Racing / Run flat tires; Oil Slick Sprayer; Personal Armor; Personality; Pilot Enhancement; Pilot Program; Pop-up mount; PPS; Ram Plate; Realistic Features; Removed Manual Controls; Retrans Unit; Rigger Cocoon; Rigger interface; Rigger services (SS); Road Strip Ejector; Road strips (Spike/Zapper/Tracking); Rocket Booster; Satellite Link; Searchlight; Secondary Manual Controls; Secondary Propulsion (6); Sensor Enhancement; Shielding (smuggling); Signature Masking; Siren (SS); SkyGuide; Smoke Projector; Smuggling Compartment (R5/SS); Special Armor Modification; Special Equipment; Speed Enhancement; Spoof chip; Spotlight; Standard/Heavy weapon mount (Core); SunCell; Suspension Mod; Thermal Smoke; Tire Mod; Touch Sensors; Valkyrie Module; Vehicle Tag Eraser; Weapon Mount (vehicle builder / drone sizes); Winch; Workshop; Yerzed Out.
