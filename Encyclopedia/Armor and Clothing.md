...
Armor is added to **Body** on Damage Resistance tests. The attack’s **AP** modifies Armor for that test. If AP drops Armor to 0 or below, you roll **Body only** (you do not subtract from Body).

If an attack dealing **Physical** damage has modified DV **less than** AP-modified Armor, the damage becomes **Stun** instead (trauma plates / padding doing their job).
...
Worn armor’s Capacity for mods is usually equal to its Armor rating (exceptions noted). Specialized protections (fire, insulation, nonconductivity, etc.) share that Capacity pool.
...
**Hardened Mil-Spec Battle Armor** uses Hardened Armor rules (same family as vehicle / critter hardened armor):

1. Compare modified DV to Hardened Armor (after AP). If DV does **not** beat that rating, the attack does **no damage** (no resistance roll).
2. If it does beat it, resist as normal with Body + Armor, and add automatic hits equal to **half** Hardened Armor (after AP, round up).

Mil-spec suits are also **Restrictive**, usually **Custom Fit**, and often grant a visible Intimidation Social Limit bump.

---

## Clothing

### Ordinary clothes (Core)
...
Non-armor shopping list for lifestyle / cover identities (Armor 0 unless you buy real armor separately):
...
| Name | Armor | Capacity | Avail | Cost | Notes |
| --- | --- | --- | --- | --- | --- |
| Berwick Suit | 9 | 5 | 9 | 2,600¥ | Classic Mortimer boardroom armor. |
| Berwick Dress | 8 | 4 | 8 | 2,300¥ | |
| Crimson Sky Suit | 8 | 5 | 6 | 2,400¥ | Slightly easier to source. |
| Summit Suit | 8 | 6 | 7 | 2,500¥ | More Capacity than Berwick dress line. |
...
| Name | Armor | Capacity | Avail | Cost | Notes |
| --- | --- | --- | --- | --- | --- |
| Ace of Cups | 9 | 8 | 6 | 1,600¥ | Ace line: stylish everyday Vashon armor. |
| Ace of Swords | 7 | 8 | 6 | 1,300¥ | |
| Ace of Wands | 6 | 8 | 6 | 1,200¥ | Lightest Ace. |
| Ace of Coins | 7 | 10 | 4 | 2,100¥ | Highest Ace Capacity. |
| Ace of Spades | 7 | 6 | 6 | 1,000¥ | |
| Ace of Clubs | 7 | 6 | 6 | 1,000¥ | |
| Ace of Hearts | 7 | 6 | 6 | 1,000¥ | |
| Ace of Diamonds | 8 | 6 | 8 | 1,400¥ | |
...
| Name | Armor | Capacity | Avail | Cost | Notes |
| --- | --- | --- | --- | --- | --- |
| Executive Suite | 12 | 4 | 12 | 2,000¥ | Jacket-tier Armor in executive cut; Capacity is tight. |
| Heritage | 4 / 6 / 8 / 10 / 12 | Armor ÷ 2 | 16 | 2,000¥ + (Armor × 500¥) | Heirloom / couture line sold at discrete ratings. Capacity = Armor ÷ 2. |
| Nightshade / Moonsilver | 7 | 2 | 10 | 8,500¥ | Ultra-fashion; almost no Capacity. |
| Second Skin | 6/+2 | 2 | 14 | 12,000¥ | Skin-layer armor: 6 alone or **+2** under/over other armor. |

### Ares Victory (sport / outdoor)

| Name | Armor | Capacity | Avail | Cost | Notes |
| --- | --- | --- | --- | --- | --- |
| Globetrotter Clothing | 7 | 10 | 6 | 600¥ | Travel / outdoor lifestyle armorweave. High Capacity for the Armor. |
| Globetrotter Vest | 9 | 10 | 7 | 900¥ | |
| Globetrotter Jacket | 12 | 10 | 10 | 1,300¥ | Jacket Armor with adventure branding. |
| Wild Hunt | 12 | 10 | 12 | 3,000¥ | Aggressive outdoor combat cut. |
| Industrious | 9 | 6 | 6 | 1,100¥ | Workwear armor. |
| Big Game Hunter | 14 | 12 | 12 | 5,000¥ | Heavy sport-hunter plating. |
| Rapid Transit | 9 | 6 | 10 | 400¥+ | Commuter / courier armor. Base price low; options and packaging push cost up. |

---

## Specialty armor (Run & Gun)

### Concealable & personal

| Name | Armor | Capacity | Avail | Cost | Notes |
| --- | --- | --- | --- | --- | --- |
| Form-Fitting Body Armor | 8 | 3 | 8 | 1,300¥ | Tailored second skin under clothes. **Custom Fit**, Concealability −6. Hands/feet/head left exposed so it stays hidden. Low Capacity. |
| Body Armor Bag | 8 | 4 | 8 | 750¥ | Looks like luggage / gear bag; unfolds or is worn as Armor 8. Smuggle protection through checkpoints that ignore “bags.” |
...
| SecureTech PPP Arms Kit | +1 | 1 | 6 | 250¥ | Modular plate packs (Personal Protection Package). Stack accessory Armor vs Strength. |
| SecureTech PPP Legs Kit | +1 | 1 | 6 | 300¥ | |
| SecureTech PPP Vitals Kit | +1 | 1 | 6 | 350¥ | |
| Ares FlaShield | +6 | 4 | 12R | 4,000¥ | Flashy ballistic shield with Ares toys; same +6 accessory Armor as Core shields, lower Capacity. |

### Security, SWAT, mil-spec
...
| SWAT Armor | 15 | 15 | 16R | 8,000¥ | Police entry armor; full Capacity 15. |
| SWAT Helmet | +3 | 8 | 10R | 1,500¥ | |
| Riot Control Armor | 14 | 8 | 10R | 5,000¥ | Crowd-control bulk; Capacity lower than Armor. |
| Riot Control Helmet | +2 | 6 | 6R | 1,000¥ | |
| Hardened Mil-Spec Battle Armor, Light | 15 | 15 | 16F | 15,000¥ | **Hardened Armor** rules. Custom Fit, Gear Access, Restrictive. Visible Intimidation Social Limit +2. Forbidden. |
| Hardened Mil-Spec Battle Armor, Medium | 18 | 18 | 18F | 20,000¥ | Same features; thicker plate. |
| Hardened Mil-Spec Battle Armor, Heavy | 20 | 20 | 22F | 25,000¥ | Top mil-spec shell. |
| Hardened Mil-Spec Battle Armor, Helmet | +3 | 8 | 8F | 10,000¥ | Matching hardened lid. |

### Sport & duty

| Name | Armor | Capacity | Avail | Cost | Notes |
| --- | --- | --- | --- | --- | --- |
| Bike Racing Armor | 8 | 8 | 6 | 500¥ | Motorcycle leathers/composites. Legal-looking on the highway. |
| Bike Racing Helmet | +2 | 6 | 6 | 200¥ | |
| Bunker Gear | 6 | 6 | 6 | 3,000¥ | Firefighter turnout. Built for heat/smoke scenes more than bullets. |
| Bunker Gear Helmet | +2 | 3 | 6 | 750¥ | |

---

## Environmental armor (Run & Gun)

| Name | Environment | Armor | Capacity | Avail | Cost | Notes |
| --- | --- | --- | --- | --- | --- | --- |
